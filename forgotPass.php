            ...
            <div class="col-12 ">
                <div class="row col-12 d-flex justify-content-center align-items-center p-3">
                    ...
                    <div class="col-8 col-lg-4 loginbox p-3 mt-lg-5 row " id="loginBox">
                        <h1 class="fw-bold col-12 mb-3">Reset Your Password</h1>

                        <div class="col-12 d-none" id="fpmsgdiv">
                            <div class="" role="alert" id="fpmsg">
                        ...
                        <div class="col-12 col-lg-8 mb-2">
                            ...
                            <input type="email" class="form form-control disabled" id="femail" value="<?php echo ($lemail)  ?>" />
                        </div>

                        <div class="col-12 col-lg-4 mb-2">
                            <button class="btn btn-outline-success" onclick="sendvcode();">Send Verification code</button>
                        </div>

                        <div class=" col-12 col-lg-12 mb-2 ">
                            <label for="">Veryfication Code</label>
                            <input type="text" class="form form-control" id="passwordvcode" />
                        </div>

                        <div class="col-10 col-lg-10 mb-2 ">
                            <label for="">New password</label>
                            <input type="password" class="form form-control " id="f1password" />
                        </div>
                        ...
                        <div class="col-10 col-lg-10 mb-3 ">
                            ...
                            <input type="password" class="form form-control" id="f2password" />
                        </div>
                        <div class="col-2 col-lg-2  mt-2">
                            <i class="bi bi-eye-slash col-1 cursor  d-flex mt-4" id="eye2" onclick="p2show();"></i>
                        </div>
                        ...
                        <div class="col-12 d-grid col-lg-6 mb-2 d-none" id="loginnow">
                            <a href="http://localhost/teddyfashon/signin.php" class="col-12 d-grid text-decoration-none">
                                <button class="btn btn-outline-info" onclick="resetpassword();">Login Now</button>
                            </a>
                        </div>
